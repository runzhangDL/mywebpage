    ...
    <div className={styles.container}>
      ...
      <main>
        ...
        <article className={styles.bio}>
          ...
          <p>I consider myself primairly a software engineer. Previously, I've got some experience in writing C/C++ and Python code to implement algorithms and process data in various modalities, such as projects on deep learning(or AI in a fancy way) to solve some real-world probelms. Right now, I am learning a broader range of tecnologies like full-stack and database, to become a more professional engineer. I enjoy doing meaningful and challenging work.</p>
        ...
        <div className={styles.eduwork}>
          ...
          <div className={styles.eduworkcol}>
            ...
            <li class={styles.workitem}>
              ...
              <div class={styles.workcompany}>AIIT, Peking University</div>
