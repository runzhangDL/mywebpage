        ...
        <div className={styles.projectContainer}>
            ...
            <div>
                ...
                <p>
                  ...
                  {/* For instance, there might be minor noise in the point cloud data. After manually observing a large number of such data points, we can gain insights into their patterns and identify features that are likely to play a role in recognizing those noise points. Therefore, bird's-eye view clustering can be applied to separate the space and split the scene into many parts of continuous objects. Then, point-wise classification is applied to each object. Although this idea sounds simple, this method has proven to perform surprisingly well in terms of computing speed and accuracy. */}
            </p>
            </div>
        </div>
